...
CHROME_PACKAGE_VERSION = "151.0.7922.169-1"
CHROME_VERSION = "151.0.7922.169"
CHROME_SHA256 = "sha256:3059e7448d906793a7116351739d3096d232d1516e8bf19209b1e2957d5e7662"
...
def test_package_contract_requires_actual_system_chrome_and_playwright_node() -> None:
    ...
    with pytest.raises(ValueError, match="google-chrome-stable"):
        parse_package_requirements(
            "python:playwright=1.62.0,binary:chrome=151.0.7922.169,binary:node=24.18.1"
        )
