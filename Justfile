...
aws_batch_scraper_required_sbom_packages := "python:playwright=1.62.0,deb:google-chrome-stable=153.0.8010.52-1,deb:libcurl3t64-gnutls=8.18.0-1ubuntu2.5,deb:libaom3=3.13.1-2ubuntu0.1,deb:bubblewrap=0.12.0-0philly1,binary:node=24.18.1"
aws_batch_scraper_chrome_executable_sha256 := "sha256:0ba9d6c54dbc1a46dfaa5f95d5975bc9b963030c8647880f5b6a537f8af7d2e8"
